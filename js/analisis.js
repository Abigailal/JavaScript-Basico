...
// 3. Mostrar los ingresos en la "table" en forma de resumen.
const listaConceptos = document.getElementById("concepts");


// Función que muestra los ingresos con el simbolo "+" 
...
const mes = document.getElementById("month-number");
const annio = document.getElementById("year-number");
var today = new Date();
